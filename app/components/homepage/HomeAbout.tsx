...
const HomeAbout = (props: Props) => {
  return (
    <section className="home-about px-6 py-24 bg-[var(--dark-green)] flex md:flex-row-reverse flex-col md:items-start gap-[3rem] md:gap-[5rem]">
      ...
      <div className=" flex flex-col items-start gap-7 md:w-[45%]">
        ...
        <p className="text-white">
          ...
          health of our land and customers. Capturing a significant market share
          within the local or regional agricultural market.
        </p>
