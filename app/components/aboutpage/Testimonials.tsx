...
const Testimonials = () => {
  return (
    <section className="pt-24 px-9 bg-[url('https://res.cloudinary.com/dv9aqxptd/image/upload/v1748962045/agro-ally/review_bg_1_sr6kig.png')] bg-cover bg-center min-h-[60vh] flex flex-col items-center justify-center gap-2">
      <SecHeading
        ...
        divStyle={"items-center justify-center flex flex-col"}
      />
